...
Amplitudes are shown exactly by default: `1/√2`, `(1-i)/2`, `ω` (= e^{iπ/4}, explained on
the plate whenever it appears). The picker in the top right switches to floating point,
either rectangular (`0.5-0.5i`) or polar (`0.3536∠-45°`). Symbolic amplitudes keep their
